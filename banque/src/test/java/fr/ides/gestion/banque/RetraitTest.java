...
public class RetraitTest extends CommonTest{
	...
	public void testRetrait(){
		Compte compte1 = banqueMetier.consulterCompte("compte1027_1");
		banqueMetier.retrait("compte1027_1", 500);
		Compte compte2 = banqueMetier.consulterCompte("compte1027_1");
	...
	@BeforeClass
	 public static void beforeTest() {
		...
		FlatXmlDataSetBuilder xmlDSBuilder = new FlatXmlDataSetBuilder();
	      ...
	      inputStreamXML = new FileInputStream("src/test/resources/dataSet/Client.xml");
